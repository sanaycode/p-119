...
console.log("Sketch to be drawn is "+Element_of_array);
document.getElementById("sketch_to-be_drawn").innerHTML=Element_of_array;
...
function draw(){
    ...
    if(drawn_sketch==Element_of_array){
        answer_holder="set";
        score=score+1;
        document.getElementById("score_lbl").innerHTML=score;
    }
}
function check_sketch(){
    timer_counter=timer_counter+1;
    document.getElementById("timer_lbl").innerHTML=timer_counter;
